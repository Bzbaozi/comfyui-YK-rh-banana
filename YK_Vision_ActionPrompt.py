...
class YK_Vision_ActionPrompt:
    ...
    def 生成编辑提示词(self, 图像, 使用API, API密钥, API模型, 展示品类, 插口袋动作, 细节数量,
...
# 注册节点
NODE_CLASS_MAPPINGS = {
    "YK_Vision_ActionPrompt": YK_Vision_ActionPrompt
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "YK_Vision_ActionPrompt": "YK视觉编辑提示词生成器（Banana2角度选择版）"
}
